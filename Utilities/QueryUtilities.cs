        ...
        public static DataTable CreateSQLDataTable(SqlConnection sqlConn, SqlCommand sqlCmd, string dataTableName)
        {
            ...
            try
            {
                ...
                if (numFilledRows < 1)
                {
                    ...
                    MessageBox.Show("Your query produced no results.  Please confirm that the correct layer has been selected for your query and try again, if you feel this is in error.",
